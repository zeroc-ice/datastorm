...
namespace DataStormI
{
    ...
    protected:
        ...
        public:
            ...
            std::map<long long int, ElementSubscribers>& getAll() { return _elements; }
    ...
    public:
        ...
        virtual void
        attachElements(long long int, DataStormContract::ElementSpecSeq, bool, const Ice::Current&) override;
        virtual void
        attachElementsAck(long long int, DataStormContract::ElementSpecAckSeq, const Ice::Current&) override;
